...
const SelectInputWithFormik = ({ label, clearable, ...props }) => {
          ...
          <main className={"selector_wrap"}>
            ...
            <section className={"selected-base"}>
              ...
              <div className={"controls"}>
                ...
                <span className={"arrow"} onClick={handleShowList}>
      ...
      <InputWrapper {...props}>
        <SelectWrapper ref={inputRef} {...props}>
          <main className={"selector_wrap"}>
            ...
            <section className={"selected-base"}>
              <aside className={"selected"} onClick={handleShowList}>
                {state.selectValue || props.defaultValue}
              </aside>
...
export const __SelectInput = ({ withFormik, ...props }) => {
  return withFormik ? (
    <SelectInputWithFormik {...props} />
  ) : (
