 ...
 * EmBED SimpleTab component
 */

import React from "react";
import _ from "lodash";
import { SimpleTabStylesWrapper } from "./SimpleTab.styles";
...
export class SimpleTab extends React.Component {
  ...
  spliceTabs = () => {
    ...
    const el = document.getElementsByClassName("tab__item-simple");
    ...
    return (
      <SimpleTabStylesWrapper>
        <ul
          ...
          <span style={style} className="indicator" />
        ...
        {children.map((child, index) => {
          return (
            <div key={generateID(20)} className="s-content">
              <div
