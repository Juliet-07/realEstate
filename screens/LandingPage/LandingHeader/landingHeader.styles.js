...
import Home from '../../../assets/images/bng/homeBackground.jpg';
...
export const LandingHeaderBox = styled('div')`
  ...
  .overlay {
    ...
    background: -moz-linear-gradient(65deg, rgba(0, 51, 51, 0.88) 5%, rgba(16, 119, 119, 0.66) 33%, rgba(251, 251, 251, 0) 100%);
